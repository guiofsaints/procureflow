    ...
    paths: {
      ...
      '/items': {
        get: {
          ...
          description:
            'Search for items in the catalog by keyword (optional)',
          tags: ['Catalog'],
          parameters: [
            {
              name: 'q',
              in: 'query',
              description: 'Search keyword (searches name, description, category)',
              required: false,
              schema: {
                type: 'string',
              },
        ...
        post: {
          ...
          description: 'Register a new item in the catalog (requires authentication)',
          tags: ['Catalog'],
          requestBody: {
            required: true,
            content: {
      ...
      '/cart': {
        get: {
          ...
          description: 'Retrieve the current user\'s cart (requires authentication)',
          tags: ['Cart'],
          responses: {
            '200': {
