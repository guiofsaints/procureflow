...
|------|----------|-----------|--------|
| 2025-11-01 | Use Next.js 15 App Router | Server Components, file routing, API routes | Simplified architecture |
| 2025-11-01 | MongoDB over PostgreSQL | Document model for carts/PRs, text search, M0 free tier | Flexible schema, cost savings |
| 2025-11-01 | Feature-based structure | Isolated modules, better scalability | Improved maintainability |
| 2025-11-01 | Service layer pattern | Framework-agnostic logic, testability | Decoupled business logic |
| 2025-11-02 | OpenAI GPT-3.5-turbo | Cost ($0.002/1K tokens) + speed (< 2s) | AI agent feasibility |
| 2025-11-02 | LangChain for orchestration | Function calling abstractions, memory | Simplified agent development |
| 2025-11-03 | Pulumi (TypeScript IaC) | Same language as app, type safety | Consistent dev experience |
| 2025-11-03 | GCP Cloud Run | Serverless, auto-scaling, pay-per-use | Cost optimization |
