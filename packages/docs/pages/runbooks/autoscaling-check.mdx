...
Via Cloud Console:
1. Navigate to **Cloud Run** → **procureflow-web**
2. Click **Metrics** tab
3. View:
...
- [ ] Scaling responsive (up in <30s, down after 15 min idle)
- [ ] P95 latency < 2s
- [ ] CPU utilization < 80%
...
# Cost: $0.024/hour × 0.1 × 730 hours/month = ~$1.75/month

# Prod: 1 min instance, 100 max
# Assumption: Average 5 instances running
# Cost: $0.024/hour × 5 × 730 hours/month = ~$87.60/month
```
