...
9. **tooltip** - Replace title attributes
10. **separator** - Replace custom borders
11. **avatar** - Use in UserMenu
12. **sheet** - Mobile sidebar
13. **dialog** - Future modals
14. **skeleton** - Loading states
15. **progress** - Future progress indicators

**Lower Priority (Forms & Controls):**
16. **checkbox** - Future multi-select
17. **radio-group** - Future single-choice
18. **select** - Future dropdowns
19. **switch** - Future settings
20. **form** - Future validation integration
